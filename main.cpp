...
namespace demo
{
  ...
  void QueryRemoteServer()
  {
    ...
    //execute the query
    std::vector<dicom::DataSet> result = connection.find(query, dicom::QueryRetrieve::Root::STUDY_ROOT);
  ...
  */
  void DoCMove()
  {
    ...
    try
    {
      ...
      dicom::DataSet result=connection.move("MECHGRAD", request, dicom::QueryRetrieve::Root::STUDY_ROOT);
